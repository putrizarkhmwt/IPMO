...
Multiselect.prototype = {
    ...
    _createItemList: function() {
        ...
        var c = this._createItem('span', -1, 'Pilih Semua'),
            d = m_helper.div({
    ...
    _updateText: function(a) {
        ...
        b.length == document.getElementById(a._getItemListIdentifier()).querySelectorAll('ul li').length && (c = '-- Fitur Default --'), document.getElementById(a._getInputFieldIdentifier()).value = c ? c : ''
    },
